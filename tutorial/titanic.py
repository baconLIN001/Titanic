...
def simplify_ages(df):
    ...
    group_names = ['Unkonwn', 'Baby', 'Child', 'Teenager', 'Student', 'Young Adult', 'Adult', 'Senior']
...
def simplify_fares(df):
    ...
    group_name = ['Unknown', '1_quartile', '2_quartile', '3_quartile', '4_quartile']
    categories = pd.cut(df.Fare,bins,labels=group_name)
    df.Fare = categories
    return df
...
#Run the grid search
grid_obj = GridSearchCV(clf,paramaters,scoring=accuracy_scorer)
